...
import (
	...
	"github.com/kkx999/KomariX/pkg/jsruntime/events"
	"github.com/kkx999/KomariX/pkg/jsruntime/fs"
	"github.com/kkx999/KomariX/pkg/jsruntime/internal/bridge"
	"github.com/kkx999/KomariX/pkg/jsruntime/internal/metrics"
...
func (m *Module) Load(vm *goja.Runtime, module *goja.Object) {
	...
	_ = process.Set("versions", map[string]string{"node": "0.0.0-goja", "go": runtime.Version(), "komarix": utils.CurrentVersion, "komari": utils.CurrentVersion, "hash": utils.VersionHash})
	_ = process.Set("release", map[string]string{"name": "node", "sourceUrl": "", "headersUrl": ""})
	_ = process.Set("title", "komarix-jsruntime")
