...
KomariX 是一款轻量级的自托管服务器监控工具，旨在提供简单、高效的服务器性能监控解决方案。它支持通过 Web 界面查看服务器状态，并通过轻量级 Agent 收集数据。

> [!WARNING]
> KomariX 是一款自托管的监控/控制程序，仅应部署在你拥有或已获得授权管理的系统上。在未获授权的情况下部署、访问、持久化、执行命令及从事其他滥用行为，用户需要自行承担部署和使用 KomariX 的责任。开发者不对未经授权或滥用行为及其后果承担责任。
...
有意赞助 KomariX？请通过 [电子邮箱](mailto:komari@akz.moe) 或 [Telegram](https://t.me/mamomoe) 联系开发者。
...
感谢所有为 KomariX 贡献代码、主题、插件、文档、翻译、问题报告或反馈的朋友。

<a href="https://github.com/kkx999/KomariX/graphs/contributors"><img src="https://contributors-img.web.app/image?repo=komari-monitor/komari" alt="KomariX 贡献者" width="600"></a>

## 支持项目

如果 KomariX 对你有所帮助，欢迎请作者喝一杯奶茶。感谢你的支持！
