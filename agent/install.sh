...
echo -e "${WHITE}===========================================${NC}"
echo -e "${WHITE}    KomariX Agent Installation Script     ${NC}"
echo -e "${WHITE}===========================================${NC}"
echo ""
...
if [ -n "$github_proxy" ]; then
    ...
    download_url="${github_proxy}/https://github.com/kkx999/KomariX/releases/${download_path}/${file_name}"
else
    # Direct access to GitHub releases
    download_url="https://github.com/kkx999/KomariX/releases/${download_path}/${file_name}"
fi
...
if [ "$init_system" = "nixos" ]; then
    ...
    echo -e "${CYAN}  description = \"KomariX Agent Service\";${NC}"
...
EOF
    ...
    cat > "$service_file" << EOF
[Unit]
Description=KomariX Agent Service
...
echo -e "${WHITE}===========================================${NC}"
if [ -f /etc/NIXOS ]; then
    log_success "KomariX Agent binary installed!"
